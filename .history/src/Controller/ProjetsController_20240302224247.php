...
class ProjetsController extends AbstractController
{
    ...
    public function index(ProjetsRepository $projetsRepository , Request $request ,  $id ): Response
    {
    ...
    {
        $projet = new Projets();
        $form = $this->createForm(ProjetsType::class, $projet , ['category_id' => $id]);
