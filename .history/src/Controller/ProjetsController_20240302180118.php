...
class ProjetsController extends AbstractController
{
    ...
    #[Route('/{id}/new', name: 'app_projets_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager,$cate,$id): Response
    {
        $projet = new Projets();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_projets_index', ['id'], Response::HTTP_SEE_OTHER);
        }
